...
<style>
    ...
    #player-search::placeholder {
      color: rgba(0, 0, 0, 0.5); /* Placeholder en noir avec opacité */
    }
...
.player-result {
  ...
  border-radius: 5px;
  margin-top: 5px;
  color: blue; /* Couleur du texte bleu */
  cursor: pointer;
...
<body class="index-page">
  ...
  <main class="main">
    ...
    <!-- Hero Section -->
    <section id="hero" class="hero section dark-background col-lg-10 col-md-12">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100">vote your favorite for the golden ball</h2>
            <p data-aos="fade-up" data-aos-delay="200">Enter the player's name, club or country.</p>
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background-color: black; color: white;">
      ...
      <div class="modal-body">
        ...
        <p>Voulez-vous voter pour ce joueur ?</p>
        <input type="text" id="username" placeholder="Nom" class="form-control" required>
        <input type="text" id="userNationality" placeholder="Nationalité" class="form-control" required>
        <input type="text" id="userCountry" placeholder="Pays de résidence" class="form-control" required>
        <input type="email" id="userEmail" placeholder="Email" class="form-control" required>
        <input type="text" id="userPhone" placeholder="Numéro de téléphone" class="form-control" required>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
        <button type="button" class="btn btn-primary" onClick="submitVote()">Soumettre le vote</button>
      </div>
    </div>
  </div>
</div>
        ...
        fetch(`search_player.php?query=${encodeURIComponent(query)}`)
            ...
            .then(players => {
                ...
                players.forEach(player => {
                    ...
                    playerDiv.innerHTML = `
                        <p><a href="#" onclick="showPlayerDetails('${player.full_name}', '${player.club_name}', '${player.club_country}', ${player.id})">${player.full_name}, ${player.nationality}, ${player.club_name} (${player.club_country}), ${player.position}, ${player.dorsal}, ${player.age} (Years old)</a></p>
                    `;
...
function showPlayerDetails(name, club, country, id) {
    ...
    document.getElementById("playerDetails").textContent = `Joueur évoluant au club ${club} du pays ${country}.`;
    
    // Stocke l'ID du joueur pour le vote
