    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container">
        <div class="row">
		  ...
		  <div class="col-lg-5" data-aos="fade-up" data-aos-delay="300">
			<form class="search-form" class="php-email-form">
				
					<input type="text" id="player-search" placeholder="Enter player's name" onkeyup="searchPlayer()" class="sign-up-form">
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="background-color: white;">
      <div class="modal-header">
        <h5 class="modal-title" id="playerModalLabel" style="color: darkgreen;"></h5>
        ...
        fetch(`search_player.php?query=${encodeURIComponent(query)}`)
            ...
            .then(players => {
                ...
                players.forEach(player => {
                    ...
                    playerDiv.innerHTML = `
                        <p><a href="#" onclick="showPlayerDetails('${player.full_name}', '${player.club_name}', '${player.club_country}')">${player.full_name}, ${player.nationality}, ${player.club_name} (${player.club_country}), ${player.position}, ${player.dorsal}, ${player.age} (Years old)</a></p>
                    `;
...
function showPlayerDetails(name, club, country) {
